...
<p id="footnote-008"><sup><a href="#footnote-008-backlink">4</a></sup> Whereas a period TFR is calculated as <p class="ereader-styles_IllustrationStyleFootnote"><span class="_01-ITC-New-Baskerville-Std-Italic"><math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><mfenced open="﻿" close="﻿"><mrow><mtext mathvariant="italic">TFR</mtext><mo>=</mo><msubsup><mo>∑</mo><mrow><mtext mathvariant="italic">age</mtext><mo>=</mo><mn>15</mn></mrow><mn>49</mn></msubsup><msub><mtext mathvariant="italic">ASFR</mtext><mrow><mtext mathvariant="italic">ag</mtext><mtext mathvariant="italic">e</mtext><mo mathvariant="italic">,</mo><mtext mathvariant="italic">calendar year</mtext></mrow></msub></mrow></mfenced></mrow></math></span>, completed cohort fertility could be calculated as CCF = Σ(age=15 to 49) ASFR(age, cohort) where *ASFR* is an ­age-specific fertility rate calculated with data from a calendar year or birth cohort, respectively.</p>
