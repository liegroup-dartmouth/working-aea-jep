...
Underlying data for Figures and Tables in [Khanna (2026)]({{ site.baseurl }}/papers/v40n1/khanna/paper.xhtml) in CSV format. File names correspond to the image names used in the article interior syntax.
